    ...
    <NavigationContainer>
      ...
      >
        ...
        <Stack.Screen 
          ...
          options={{ headerShown: true, title: 'Visit History' }} 
        />
        <Stack.Screen 
          name="NewVisit" 
        ...
        <Stack.Screen 
          ...
          options={{ headerShown: true, title: 'Households' }} 
        />
        <Stack.Screen 
          name="AddHousehold" 
          component={AddHouseholdScreen} 
          options={{ headerShown: true, title: 'Register Household' }} 
        />
        <Stack.Screen 
          name="Referrals" 
        ...
        <Stack.Screen 
          ...
          options={{ headerShown: true, title: 'About MedField' }} 
        />
        <Stack.Screen 
          name="UserManagement" 
        ...
        <Stack.Screen 
          ...
          component={SystemPerformanceScreen} 
          options={{ headerShown: true, title: 'System Performance' }} 
        />
        <Stack.Screen 
          name="ScalingConfig" 
          component={ScalingConfigScreen} 
          options={{ headerShown: true, title: 'Scaling Configuration' }} 
        />
      </Stack.Navigator>
    </NavigationContainer>
  );
